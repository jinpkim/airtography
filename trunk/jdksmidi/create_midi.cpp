...
int main ( int argc, char **argv )
{
    ...
    MIDIClockTime dt = 100; // time interval (100 = 1 second)
    ...
    */
    ...
    m.SetTime( t );
    m.SetNoteOn( chan = 0, note = 50, velocity = 100 );
    tracks.GetTrack( trk )->PutEvent( m );
    ...
    m.SetNoteOn( chan = 1, note = 25, velocity );
    tracks.GetTrack( trk )->PutEvent( m );
    ...
    m.SetNoteOn( chan = 2, note = 80, velocity );
    tracks.GetTrack( trk )->PutEvent( m );
    ...
    tracks.GetTrack( trk )->PutEvent( m );
    m.SetNoteOn( chan = 1, note = 67, velocity );
    tracks.GetTrack( trk )->PutEvent( m );
    m.SetNoteOn( chan = 2, note = 80, velocity );
    tracks.GetTrack( trk )->PutEvent( m );
